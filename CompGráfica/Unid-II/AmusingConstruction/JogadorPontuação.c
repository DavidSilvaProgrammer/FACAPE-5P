...
void display(void) {
    ...
    char *message = "Parabens, jogador! Voce venceu o jogo! Pontuacao: 10.0";
    ...
    glColor3f(0.0, 0.0, 0.0);
    glRasterPos2f(120, 300);
    char *message = "Game over, jogador! Voce perdeu o jogo! Pontuacao: 5.0";
    int len = strlen(message);
    int i;
    for (i = 0; i < len; i++) {
        glutBitmapCharacter(GLUT_BITMAP_TIMES_ROMAN_24, message[i]);
    ...
    glColor3f(0.0, 0.0, 0.0);
    glRasterPos2f(120, 300);
    char *message = "Game over, jogador! Voce perdeu o jogo! Pontuacao: 0.0";
    int len = strlen(message);
    int i;
    for (i = 0; i < len; i++) {
        glutBitmapCharacter(GLUT_BITMAP_TIMES_ROMAN_24, message[i]);
