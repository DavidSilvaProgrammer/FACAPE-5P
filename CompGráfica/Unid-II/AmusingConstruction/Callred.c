...
void moveRedSquare(void) {
    ...
    redSquareX = redSquareSpeedX ; // Reduzindo a velocidade pela metade
    redSquareY = redSquareSpeedY; // Reduzindo a velocidade pela metade
...
if (callred){
    	drawRedSquare(); ///aqui quadrado vermelho 
	}
