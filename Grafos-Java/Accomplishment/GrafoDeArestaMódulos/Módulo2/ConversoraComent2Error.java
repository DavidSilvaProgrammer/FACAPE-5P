...
public class Conversora {
    ...
    public static String conversorGrafoDeAresta(int[][] matriz) {
        ...
        String resultadoArestas = achaIndicesDosUns(matriz);
        
        // Verifica se o resultado indica que não foram encontradas arestas
        if (resultadoArestas.equals("O grafo de entrada não possui aresta.")) {
            return resultadoArestas; // Retorna a mensagem sem executar o restante do código
        }
        ...
        List<List<String>> listaMatriz = geradorMatriz(resultadoArestas);
